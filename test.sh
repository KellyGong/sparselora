...
CUDA_VISIBLE_DEVICES=1 python spft/test/main.py \
    --dataset gsm8k+svamp+mawps \
    --model_name_or_path checkpoints/NousResearch/Meta-Llama-3-8B-Instruct/math/lora/math_10k_b16_ep3.0_lr0.0003_peft-lora_svd_8_ffn=0.99x28-qkv=0.75x14_skip-out/41 \
