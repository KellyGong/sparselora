CUDA_VISIBLE_DEVICES=1 python spft/train/main.py \
    --report_to none \
    --logging_strategy no \
    --output_dir checkpoints/NousResearch/Meta-Llama-3-8B-Instruct/csr170k_punc \
    --seed 41 \
...
CUDA_VISIBLE_DEVICES=1 python spft/train/main.py \
    --report_to none \
    --logging_strategy no \
    --output_dir checkpoints/meta-llama/Llama-2-13b-hf/math \
    --seed 41 \
    --model_name_or_path meta-llama/Llama-2-13b-hf \
    --spft configs/sparsity/llama2-13b-dense.yaml \
    --benchmark True \
    --spft_start_step 0 \
